...
<div id="superior"> 
    ...
    <section class="container produtos">
      ...
      <article class="row">
        ...
        <a href="produtos/" class="produtos-container col-md-3">
          <!-- imagem do produto -->
          <img src="jogos/zeldabotwboxart.jpg" class="img-fluid" alt="Zelda">
  ...
  <div class="faixa">
	<ul >
    	...
    	<li class="bordali"><a href="lançamentos2.php">2</a></li>
    	<li class="bordali"><a href="lancamentos3.php">3</a></li>
    	<li class="bordali"><a href="lancamentos4.php">4</a></li>
    	<li class="bordali"><a href="lancamentos5.php">5</a></li>
