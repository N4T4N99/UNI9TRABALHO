...
.divimgplataforma{
        background-image: url("imgs/imgpromocoes.jpg"); 
        background-color: #cccccc;
        width:100%; height:450px;       
    }
    .txtimgplataforma{
        font-size:94px;  font-family: 'Staatliches', cursive;
        position:absolute; top:400px; left:800px; color:RED; 
...
<div id="superior"> 
    ...
    <div class="divimgplataforma">  <div class="txtimgplataforma">PROMOÇOES </div> </div>
