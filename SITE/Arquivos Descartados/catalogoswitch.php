...
.divimgplataforma{
        background-image: url("imgs/smowalp.jpg"); 
        background-color: #cccccc;
        width:100%; height:450px;       
    }
    .txtimgplataforma{
        font-size:94px; font-family: 'Staatliches', cursive; 
        position:absolute; top:400px; left:780px; color:yellow; 
...
<div id="superior"> 
     ...
     <a href="pagplataformas.php"><span id="cabecalho"> Plataformas &#9660; <span> </a>
     <a href="paglancamentos.php"> <span id="cabecalho2"> Lançamentos <span> </a><a href="pagpromocoes.php"> <span id="cabecalho3"> Promoçoes <span> </a>
     <a href="pagsuporte.php"> <span id="cabecalho4"> Suporte <span> </a>
    </div> 

    <div class="divimgplataforma">  <div class="txtimgplataforma"> SWITCH GAMES </div> </div>
  ...
  <div class="faixa">
	<ul >
	    <li class="bordali"> <a href="paglancamentos.php">1</a></li>
    	<li class="bordali"><a href="paglancamentos2.php">2</a></li>
    	<li class="bordali"><a href="paglancamentos3.php">3</a></li>
    	<li class="bordali"><a href="paglancamentos4.php">4</a></li>
    	<li class="bordali"><a href="paglancamentos5.php">5</a></li>
